...
namespace PastaMadnessSystem
{
    ...
    public partial class IndividualnaPorucha : Form
    {
        ...
        private void showAllItems()
        {
            ...
            CqlaSumaLbl.Text = $"Обща цена на сметката: {thisOrder.Price:F2}лв.";
        }
        ...
        private void NapitkiBtn_Click(object sender, EventArgs e)
        {
